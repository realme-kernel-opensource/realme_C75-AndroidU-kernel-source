...
int virtual_sensor_probe(void)
{
	...
	pr_err("----virtual_sensor_probe OK !!\n");
	return 0;
...
EXPORT_SYMBOL_GPL(virtual_sensor_probe);

int virtual_sensor_remove(void)
{
	int err = 0;
...
EXPORT_SYMBOL_GPL(virtual_sensor_remove);
...
#if (1) //_USE_VIRTUAL_SENSOR_AS_MODULE
