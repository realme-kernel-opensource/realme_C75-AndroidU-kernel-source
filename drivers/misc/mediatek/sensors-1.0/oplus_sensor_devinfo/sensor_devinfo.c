...
#if IS_ENABLED(CONFIG_OPLUS_SENSOR_MTK68XX)
#include "hf_sensor_type.h"
#include "mtk_nanohub.h"
#if IS_ENABLED(LINUX_KERNEL_VERSION_419)
#include "scp.h"
...
/*Sylvia mod end*/
	...
	rtc_req.req.data[4] = txc.tv_sec;
	rtc_req.req.data[5] = txc.tv_nsec/1000;//Sylvia add nsec to usec
...
//Use proc_ops replace file_operations
...
static struct proc_ops mag_para_fops = {
